<?php
	include_once("../applications/models/SideMenu.class.php");
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#user_form").submit(function(event){
				...
				$(".msg_box span").empty().html('<img src="images/ajax-loader.gif" />');
				$(".msg_box").fadeIn();
				$.ajax({
					type: "POST",
...
.user_tab .user_table { float: right; border: 2px solid #9A9A9B; padding: 5px; width: 230px; height: 500px; overflow: auto; background-color: #F9F8F2; margin-top: 8px; }
...
#user_form .class_info .detail #level:hover { background-color: #000; color: #fff; background-image:url("images/test_black_btn.png"); background-repeat:no-repeat; background-position:right top; }
...
<body>
<div class="msg_box"><span><img src="images/ajax-loader.gif" /></span></div>
<?php
...
<div class="main_content">
	<?php
		$side_menu = new SideMenu(array("user", "role", "feature"));
